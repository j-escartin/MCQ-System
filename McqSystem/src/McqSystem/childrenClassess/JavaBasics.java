 ...
 **/
public class JavaBasics extends Quiz implements ChildrenInterface{

    private Scanner input = new Scanner(System.in);
    private String path = "D:\\2022 Files\\College\\Module 2\\Assessment\\BDSE13-PFS-0622_JamesVincentEscartin" +
            "\\BDSE13-PFS-James_Vincent_Escartin_SC\\JavaBasics\\JavaBasics.csv";
            ...
            try{
                ...
                while (myReader.hasNextLine()){
                    ...
                    for(int j=0; j<storeData.length;j++){
                        twoDimenValues[i][j] = storeData[j];
                    }
                    i++;
                }
                myReader.close();
